# "Fermi-Dirac integrals and inverse of orders -1/2, 1/2, 3/2, 5/2
# Antia, H.M., Aph.J 84, 101-108 (1993)

# fermi integral related to polylogarithm:  F_j(x) = -Li_j+1(-exp(x))

from functools import wraps
from numpy import asfarray, zeros_like, exp, polyval
...
def fd_integral(anum, aden, bnum, bden):
    def fdwrapper(f):
        @wraps(f)
        def fdtemplate(x):
            x = asfarray(x)
...
@fd_integral((1.0, 1.98276889924768e3, 1.14980998186874e5, 1.83696370756153e6,
...
@fd_integral((1.0, 7.77238678539648e2, 4.16031909245777e4, 6.42493233715640e5,
...
@fd_integral((1.0, 9.90562948053193e1, 2.21876607796460e3, 1.77294861572005e4,
...
@fd_integral((1.0, 1.02589947781696e2, 2.44325236813275e3, 2.10427138842443e4,
